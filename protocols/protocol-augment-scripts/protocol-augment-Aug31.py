...
first_half = full_protocol[:67]
second_half = full_protocol[67:]

put = copy.copy(full_protocol[67])
put['waitmins'] = 0
take = copy.copy(full_protocol[68])

where_put_start = full_protocol[:36]
where_put_end = full_protocol[36:]

put_slice = []
put_slice.append(put)
put_slice.append(take)
put_slice.append(put)
put_slice.append(take)

full_protocol = []
full_protocol.extend(where_put_start)
full_protocol.extend(put_slice)
full_protocol.extend(where_put_end)
...
filename = 'FISSEQ-Aug31-mixCleave.pkl'
